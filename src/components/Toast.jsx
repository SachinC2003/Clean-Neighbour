...
const Toast = ({open,setOpen,message,color}) => {
  if(open)return (
    <div>
        <div className={`absolute top-8 max-w-xs ${color==="red"? "bg-red-500":"bg-green-500"} text-sm text-white rounded-md shadow-lg mb-3 ml-3`} role="alert">
