...
const SignupForm = () => {
    ...
    return (
        <div>
        <Alert title={"Signup error"} open={alertOpen} setAltertopen={setAltertopen} message={error}></Alert>
        <form>
            <div className="flex items-center justify-center h-screen bg-gray-100">
            <div className="bg-white py-6 rounded-md px-10 max-w-lg shadow-md">
                <h1 className="text-center text-lg font-bold text-gray-500">Sign up</h1>
                <div className="space-y-4 mt-6">
                <div className="w-full">
                    <input value={signupInfo.email} type="text" placeholder="email" className="px-4 py-2 bg-gray-50" 
                    onChange={(e)=>{
                ...
                <input value={signupInfo.password} type={showPassword ? 'text' : 'password'} placeholder="password" className="px-4 py-2 bg-gray-50" 
                  onChange={(e)=>{
                ...
                <p className='pt-2'> Already have an account? <Link className='underline text-blue-500' to={'/login'}>
                    Login
                </Link></p>
            </div>
            </div>
